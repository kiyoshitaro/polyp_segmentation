...
Retrieved from http://arxiv.org/abs/1904.11492
https://github.com/dl19940602/GCnet-pytorch/blob/master/GCnet_all.py
...
class ResNet(nn.Module):
    def __init__(
        self, block, block1, num_block, num_classes=100, gc=False, type="gc_all"
    ):
        super().__init__()

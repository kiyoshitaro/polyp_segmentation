...
class PraNetv2(nn.Module):
    def __init__(self, channel=32):
        ...
        self.bottleneck_2 = nn.Sequential(
            nn.Conv2d(512 + 64,
                      ...
                      padding=1,
                      dilation=1,
                      bias=False), BatchNorm2d(64), nn.ReLU(64),
        ...
        self.bottleneck_4 = nn.Sequential(
            nn.Conv2d(2048 + 256,
                      ...
                      padding=1,
                      dilation=1,
                      bias=False), BatchNorm2d(256), nn.ReLU(256),
    ...
    def forward(self, x):
        ...
        crop_3 = F.interpolate(x, scale_factor=2,
                               mode='bilinear')  #(bs, 1, 22, 22)
        ...
        crop_2 = F.interpolate(x, scale_factor=2,
                               mode='bilinear')  #(bs, 1, 44, 44)

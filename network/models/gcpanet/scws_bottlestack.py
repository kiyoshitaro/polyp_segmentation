...
class SCWSBottleStackNet(nn.Module):
    def __init__(self):
        super(SCWSBottleStackNet, self).__init__()
        ...
        self.long_relation = BottleStack(
            dim=inplanes, fmap_size=(11, 11), dim_out=interplanes
        )

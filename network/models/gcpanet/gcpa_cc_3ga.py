...
class GCPACC3GANet(nn.Module):
    def __init__(self):
        super(GCPACC3GANet, self).__init__()
        ...
        self.long_relation_4 = CrissCrossAttention(interplanes)
        self.long_relation_3 = CrissCrossAttention(interplanes)
        self.long_relation_2 = CrissCrossAttention(interplanes)
    ...
    def forward(self, x):
        ...
        out5_c_4 = self.long_relation_4(out5_)  # bs, 256, 11, 11
        out5_c_4 = self.long_relation_4(out5_c_4)  # bs, 256, 11, 11

        out5_c_3 = self.long_relation_3(out5_)  # bs, 256, 11, 11
        out5_c_3 = self.long_relation_3(out5_c_3)  # bs, 256, 11, 11

        out5_c_2 = self.long_relation_2(out5_)  # bs, 256, 11, 11
        out5_c_2 = self.long_relation_2(out5_c_2)  # bs, 256, 11, 11

        # GCF
        out4_c = self.local_attention_4(out5_c_4)  # bs, 256, 11, 11

        out3_c = self.local_attention_3(out5_c_3)  # bs, 256, 11, 11

        out2_c = self.local_attention_2(out5_c_2)  # bs, 256, 11, 11
        # HA

...
class GCEECENet(nn.Module):
    def __init__(self):
        super(GCEECENet, self).__init__()
        ...
        self.long_relation = DACblock_with_inception(inplanes)
    ...
    def forward(self, x):
        ...
        # RCCA
        out5_c = self.conva(self.long_relation(out5))  # bs, 256, 11, 11

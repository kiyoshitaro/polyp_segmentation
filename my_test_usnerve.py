...
def main():
    ...
    for id in list(folds.keys()):
        ...
        for e in epochs:
            ...
            import pandas as pd
            from utils.utils import rle_encoding
            ...
            for i, pack in tqdm.tqdm(enumerate(test_loader, start=0)):
                ...
                # res = F.upsample(
                #     res, size=(420, 580), mode="bilinear", align_corners=False
                # )

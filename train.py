...
def train(train_loader, test_loader, model, optimizer, epoch, test_fold,
          writer, args):
    ...
    if (version == 0 or version == 1 or version == 2 or version == 3):
        ...
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                ...
                if rate == 1:
                    ...
                    writer.add_scalar("Loss1", loss_record2.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss2", loss_record3.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss3", loss_record4.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss4", loss_record5.show(),
                                      (epoch - 1) * len(train_loader) + i)
        ...
        loss_recordx4, loss_record2, loss_record3, loss_record4, loss_record5 = AvgMeter(
        ...
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                ...
                # ---- forward ----
                x4_head_out, lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2 = model(
                    images)
                ...
                if rate == 1:
                    ...
                    writer.add_scalar("loss_recordx4", loss_recordx4.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss1", loss_record2.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss2", loss_record3.show(),
          ...
          or version == 17 or version == 18):
        loss_recordx3, loss_record2, loss_record3, loss_record4, loss_record5 = AvgMeter(
        ), AvgMeter(), AvgMeter(), AvgMeter(), AvgMeter()
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                optimizer.zero_grad()
                ...
                # ---- forward ----
                x3_head_out, lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2 = model(
                    images)
                ...
                if rate == 1:
                    ...
                    writer.add_scalar("loss_recordx3", loss_recordx3.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss1", loss_record2.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss2", loss_record3.show(),
        ...
        loss_recordx_GALD, loss_recordx_DUAL, loss_record2, loss_record3, loss_record4, loss_record5 = AvgMeter(
        ...
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                ...
                # ---- forward ----
                x_gald_head_out, x_dual_head_out, lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2 = model(
                    images)
                ...
                loss2 = structure_loss(lateral_map_2, gts)
                loss = (lossx_dual +
                        lossx_gald) * 2 + loss2 + loss3 + loss4 + loss5
                ...
                if rate == 1:
                    ...
                    writer.add_scalar("loss_recordx_GALD",
                                      loss_recordx_GALD.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_recordx_DUAL",
        ...
        loss_record5_new, loss_record4_new, loss_record3_new, loss_record2_new, loss_record1_new, loss_record0_new, loss_record2, loss_record3, loss_record4, loss_record5 = AvgMeter(
        ), AvgMeter(), AvgMeter(), AvgMeter(), AvgMeter(), AvgMeter(
        ), AvgMeter()
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                ...
                # ---- forward ----
                lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2, new_lateral_map_5, new_lateral_map_4, new_lateral_map_3, new_lateral_map_2, new_lateral_map_1, new_lateral_map_0 = model(
                    images)
                ...
                if rate == 1:
                    ...
                    writer.add_scalar("loss_record5_new",
                                      loss_record5_new.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_record4_new",
                                      loss_record4_new.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_record3_new",
                                      loss_record3_new.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_record2_new",
                                      loss_record2_new.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_record1_new",
                                      loss_record1_new.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_record0_new",
        ...
        for i, pack in enumerate(train_loader, start=1):
            for rate in size_rates:
                ...
                # ---- forward ----
                x3_head_out, x2_head_out, lateral_map_5, lateral_map_4, lateral_map_3, lateral_map_2 = model(
                    images)
                ...
                if rate == 1:
                    ...
                    writer.add_scalar("loss_recordx3", loss_recordx3.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("loss_recordx2", loss_recordx2.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss1", loss_record2.show(),
                                      (epoch - 1) * len(train_loader) + i)
                    writer.add_scalar("Loss2", loss_record3.show(),
    ...
    v = version
    loss_recordx2, loss_recordx4, loss_recordx_GALD, loss_recordx_DUAL, loss_recordx3, loss_record2, loss_record3, loss_record4, loss_record5 = AvgMeter(
    ...
    for i, pack in enumerate(test_loader, start=1):
        ...
        if (v == 0 or v == 1 or v == 2 or v == 3):
            ...
            writer.add_scalar("Loss1_test", loss_record2.show(),
        ...
        elif (v == 4 or v == 5 or v == 13 or v == "GALD" or v == 14 or v == 15
              or v == 16 or v == 17 or v == 18):
            ...
            loss = lossx3
            loss_recordx3.update(lossx3.data, 1)
            writer.add_scalar("Loss1_test", loss_recordx3.show(),
                              (epoch - 1) * len(test_loader) + i)
    ...
    if (epoch + 1) % 3 == 0 and epoch > save_from or epoch == 23:
        ...
        Log.info('[Saving Snapshot:]' + save_path + 'PraNetDG-' + test_fold +
                 '-%d.pth' % epoch)
...
if __name__ == "__main__":
    ...
    start_from = 0
    save_from = 160
    name = [[1, 2, 3, 4], [0, 2, 3, 4], [0, 1, 3, 4], [0, 1, 2, 4],
            [0, 1, 2, 3]]
    ...
    if start_from != 0:
        restore_from = "./snapshots/PraNetv{}_Res2Net_kfold/PraNetDG-fold{}-{}.pth".format(
            v, i, start_from)
    ...
    for epoch in range(start_from, 200):
        ...
        train(train_loader, test_loader, model, optimizer, epoch, test_fold,
              writer, args)
        scheduler.step()

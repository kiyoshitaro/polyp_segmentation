...
train_img_paths = []
train_mask_paths = []
train_data_path = ["/home/admin_mcn/hung/polyp_segmentation/data/ISIC2018_Task1/traindataset"]
...
for i in range(len(train_data_path)):
    directory_imgaug = os.path.join(train_data_path[i]+"_aug_352","images")
    if not os.path.exists(directory_imgaug):
        os.makedirs(directory_imgaug)
    directory_maskaug = os.path.join(train_data_path[i]+"_aug_352","masks")
